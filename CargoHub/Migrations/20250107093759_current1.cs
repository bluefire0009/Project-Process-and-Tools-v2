...
namespace CargoHub.Migrations
{
    ...
    /// <inheritdoc />
    public partial class current1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrdersInShipment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrdersInShipment_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrdersInShipment_Shipments_ShipmentId",
                        column: x => x.ShipmentId,
                        principalTable: "Shipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipmentsInOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShipmentsInOrders_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShipmentsInOrders_Shipments_ShipmentId",
                        column: x => x.ShipmentId,
                        principalTable: "Shipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrdersInShipment_OrderId",
                table: "OrdersInShipment",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OrdersInShipment_ShipmentId",
                table: "OrdersInShipment",
                column: "ShipmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipmentsInOrders_OrderId",
                table: "ShipmentsInOrders",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_ShipmentsInOrders_ShipmentId",
                table: "ShipmentsInOrders",
                column: "ShipmentId");
