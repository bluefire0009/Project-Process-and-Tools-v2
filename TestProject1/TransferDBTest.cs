...
public class TransferDBTest
{
    ...
    public static IEnumerable<object[]> AddTransferTestData => new List<object[]>
        {
            ...
            new object[] { null, null, null, false},
            new object[] { null, new List<Item>(){new(){Uid = "P000001"}}, new Transfer(){Id = -1, Items = {new() {TransferId = -1, ItemUid = "P000001"}}}, false},
            new object[] { null, new List<Item>(){new(){Uid = "P000001"}}, new Transfer(){Id = 0, Items = {new() {TransferId = 0, ItemUid = "P000001"}}}, false},
            new object[] { null, null, new Transfer(){Id = -1, Items = {new() {TransferId = -1, ItemUid = "P000000"}}}, false},
            new object[] { null, null, new Transfer(){Id = 0, Items = {new() {TransferId = 0, ItemUid = "P000000"}}}, false},
            new object[] { null, null, new Transfer(){Id = -1, Items = {new() {TransferId = -1, ItemUid = ""}}}, false},
            new object[] { null, null, new Transfer(){Id = 0, Items = {new() {TransferId = 0, ItemUid = ""}}}, false},
            new object[] { null, new List<Item>(){new(){Uid = "P000001"}}, new Transfer(){Id = 1, Items = {new() {TransferId = 1, ItemUid = "P000001"}, new(){TransferId = 1, ItemUid = "P000001"}}}, false},
            new object[] { null, new List<Item>(){new(){Uid = "P000001"}}, new Transfer(){Id = 1, Items = {new(){TransferId = 2, ItemUid = "P000001"}}}, false},
            new object[] { new List<Location>(){new(){Id = 1}, new(){Id = 2}}, new List<Item>(){new(){Uid = "P000001"}}, new Transfer(){Id = 1, TransferFrom = 3, TransferTo = 4, Items = {new(){TransferId = 2, ItemUid = "P000001"}}}, false},
            new object[] { new List<Location>(){new(){Id = 1}, new(){Id = 2}}, new List<Item>(){new(){Uid = "P000001"}}, new Transfer(){Id = 1, TransferFrom = 4, TransferTo = 2, Items = {new(){TransferId = 2, ItemUid = "P000001"}}}, false},
            new object[] { new List<Location>(){new(){Id = 1}, new(){Id = 2}}, new List<Item>(){new(){Uid = "P000001"}}, new Transfer(){Id = 1, TransferFrom = 2, TransferTo = 4, Items = {new(){TransferId = 2, ItemUid = "P000001"}}}, false},
            new object[] { new List<Location>(){new(){Id = 1}, new(){Id = 2}}, new List<Item>(){new(){Uid = "P000001"}}, new Transfer(){Id = 1, TransferFrom = 2, TransferTo = 2, Items = {new(){TransferId = 2, ItemUid = "P000001"}}}, false},
            new object[] { new List<Location>(){new(){Id = 1}, new(){Id = 2}}, new List<Item>(){new(){Uid = "P000001"}}, new Transfer(){Id = 1, TransferFrom = 2, TransferTo = 1, Items = {new(){TransferId = 2, ItemUid = "P000001"}}}, false},

            new object[] { new List<Location>(){new(){Id = 1}, new(){Id = 2}}, new List<Item>(){new(){Uid = "P000001"}}, new Transfer(){Id = 1, TransferFrom = 1, TransferTo = 2, Items = {new(){TransferId = 1, ItemUid = "P000001"}}}, true},
            new object[] { new List<Location>(){new(){Id = 1}, new(){Id = 2}}, new List<Item>(){new(){Uid = "P000001"}, new(){Uid = "P000002"}}, new Transfer(){Id = 1, TransferFrom = 1, TransferTo = 2, Items = {new(){TransferId = 1, ItemUid = "P000001"}, new(){TransferId = 1, ItemUid = "P000002"}}}, true}
        };
    [TestMethod]
    ...
    public static IEnumerable<object[]> RemoveTransferTestData => new List<object[]>
        {
            ...
            new object[] { new List<Item> {new(){Uid = "P000001"}, new(){Uid = "P000002"}}, new List<Transfer> { new Transfer(){Id = 1, Items = new(){ new(){TransferId = 1, ItemUid = "P000001"}, new(){TransferId = 1, ItemUid = "P000002"}}}}, 1, true},
            new object[] { new List<Item> {new(){Uid = "P000001"}, new(){Uid = "P000002"}}, new List<Transfer> { new Transfer(){Id = 1}, new Transfer(){Id = 2, Items = new(){ new(){TransferId = 2, ItemUid = "P000001"}, new(){TransferId = 2, ItemUid = "P000002"}}}}, 2, true}
        };
    [TestMethod]
    ...
    public static IEnumerable<object[]> UpdateTransferTestData => new List<object[]>
        {
            ...
            new object[] { new List<Item>{new(){Uid = "P000001"}, new(){Uid = "P000002"}}, new List<Transfer> {new Transfer(){Id = 1, Items = new(){ new(){TransferId = 1, ItemUid = "P000001"}}}}, 1, new Transfer(){Id = 2, Items = { new(){TransferId = 2, ItemUid = "P000003"}, new(){TransferId = 2, ItemUid = "P000004"}}}, false},
            new object[] { new List<Item>{new(){Uid = "P000001"}, new(){Uid = "P000002"}}, new List<Transfer> {new Transfer(){Id = 1, Items = new(){ new(){TransferId = 1, ItemUid = "P000001"}}}}, 1, new Transfer(){Id = 2, Items = { new(){TransferId = 3, ItemUid = "P000001"}, new(){TransferId = 3, ItemUid = "P000002"}}}, false},
            new object[] { null, new List<Transfer> {new Transfer(){Id = 1}}, 1, new Transfer(){Id = 2}, false},

            new object[] { new List<Item>{new(){Uid = "P000001"}, new(){Uid = "P000002"}}, new List<Transfer> {new Transfer(){Id = 1, Items = new(){ new(){TransferId = 1, ItemUid = "P000001"}}}}, 1, new Transfer(){Id = 1, Items = { new(){TransferId = 2, ItemUid = "P000001"}, new(){TransferId = 2, ItemUid = "P000002"}}}, false},
    ...
    public static IEnumerable<object[]> CommitTransferTestData => new List<object[]>
    {
        ...
        new object[] { 
            new List<Inventory> {
                new(){Id = 1, ItemId = "P000001", InventoryLocations = {new(){InventoryId = 1, LocationId = 1}}, total_on_hand = 100, total_available = 100},
                new(){Id = 2, ItemId = "P000002", InventoryLocations = {new(){InventoryId = 2, LocationId = 1}}, total_on_hand = 100, total_available = 100}},
            new List<Location> {new(){Id = 1}, new(){Id = 2}}, 
            new List<Item> {new(){Uid = "P000001"}, new(){Uid = "P000002"}}, 
            new List<Transfer> {new(){
                Id = 1, TransferFrom = 1, TransferTo = 2, 
                Items = {
                    new(){ItemUid = "P000001", TransferId = 1, Amount = 110}, 
                    new(){ItemUid = "P000002", TransferId = 1, Amount = 110} }}}, 
            1,
            false,
        ...
        new object[] { 
            ...
            new List<Transfer> {new(){
                Id = 1, TransferFrom = 1, TransferTo = 2, 
                Items = {
                    new(){ItemUid = "P000001", TransferId = 1, Amount = 90}, 
                    new(){ItemUid = "P000002", TransferId = 1, Amount = 110} }}}, 
            1,
            false,
            TransferDBStorage.TransferResult.notEnoughItems},
        ...
        new object[] { 
            ...
            new List<Transfer> {new(){
                ...
                Items = {
                    new(){ItemUid = "P000001", TransferId = 1, Amount = 90}, 
                    new(){ItemUid = "P000002", TransferId = 1, Amount = 90} }}}, 
            1,
            true,
        ...
        new object[] { 
            ...
            new List<Transfer> {new(){
                Id = 1, TransferFrom = 1, TransferTo = 2, 
                Items = {
                    new(){ItemUid = "P000001", TransferId = 1, Amount = 100}, 
                    new(){ItemUid = "P000002", TransferId = 1, Amount = 100} }}}, 
            1,
            true,
            TransferDBStorage.TransferResult.possible},
    };
